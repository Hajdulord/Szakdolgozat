...
\supervisor{Kovácsné Pusztai Kinga} % belső témavezető neve / internal supervisor's name
\affiliation{tanársegéd, MSc} % belső témavezető beosztása / internal supervisor's affiliation
...
\renewcommand{\therowcntr}{\thesubsection.\arabic{rowcntr}}

% A new columntype to apply automatic stepping
\newcolumntype{N}{>{\refstepcounter{rowcntr}\therowcntr}m{0.1\textwidth}}
